...
\caption{{Amostragem. Fonte: }\url{https://susanasousa.wordpress.com/2011/01/23/audio-digital-frequencia-de-amostragem-bits-por-amostra-e-criterio-de-nyquist/}}
\label{amos}
\end{figure}
...
\begin{figure}[!h]
\centering
\includegraphics[width=2.5in]{Imagens/baix}
% where an .eps filename suffix will be assumed under latex, 
% and a .pdf suffix will be assumed for pdflatex; or what has been declared
% via \DeclareGraphicsExtensions.
\caption{{Passa baixas. Fonte: } {\url{https://pt.wikipedia.org/wiki/Filtro_passa-baixo}}}
\label{baixa}
\end{figure}

\begin{figure}[!h]
\centering
\includegraphics[width=2.5in]{Imagens/altas}
% where an .eps filename suffix will be assumed under latex, 
% and a .pdf suffix will be assumed for pdflatex; or what has been declared
% via \DeclareGraphicsExtensions.
\caption{{Passa alta. Fonte: } {\url{https://leoknuppe.wordpress.com/2013/12/16/projeto-filtro-passa-faixa/}}}
\label{alta}
\end{figure}

\begin{figure}[!h]
\centering
\includegraphics[width=2.5in]{Imagens/banda}
% where an .eps filename suffix will be assumed under latex, 
% and a .pdf suffix will be assumed for pdflatex; or what has been declared
% via \DeclareGraphicsExtensions.
\caption{{Passa banda. Fonte: } {\url{https://pt.wikipedia.org/wiki/Filtro_passa-faixa}}}
\label{banda}
\end{figure}
